...
| ----- | ---------------------- | ---------------------------- | ---------------- |
| Alpha | Gateway & Auth         | @Navidtor, @amirrezamaqsoudi | Claude, ChatGPT  |
| Beta  | Booking & Resources    | @GhazaleESK, @tinabaouj      | ChatGPT          |
| Gamma | Marketplace & Payments | @xxheka, @sophiedlk          | Gemini , ChatGPT |
| Delta | Exams & Notifications  | @Mariahdlk1989, @xanahid     | ChatGPT          |
...
> "ChatGPT suggested using `ServerHttpRequest.mutate()` to create a modified request with new headers. I didn't know requests were immutable in WebFlux."
...
**AI Tool:** ChatGPT (Primary), Gemini (Secondary)  
...
> "ChatGPT helped me understand that each step needs a 'undo' action. If step 3 fails, I need to undo step 2 (cancel payment)."
...
| -------------- | ------------------------------ | ------------------------- | ------------------- |
| **Best For**   | Code completion                | Architecture              | Quick answers       |
| **Strengths**  | IDE integration, context-aware | Long documents, reasoning | Speed, multimodal   |
| **Weaknesses** | Sometimes outdated             | Less code-focused         | Newer, less trained |
| **Our Usage**  | 60%                            | 15%                       | 25%                 |
...
| Implementation | ChatGPT      | Real-time code suggestions         |
...
| ----------------- | -------------- | ----- | ----------------- |
| @Navidtor         | 12             | 25    | Gateway, Security |
| @amirrezamaqsoudi | 10             | 22    | Auth, JWT         |
| @GhazaleESK       | 10             | 16    | JPA, Locking      |
| @tinabaouj        | 11             | 17    | React, UI         |
| @xxheka           | 12             | 20    | Saga, Events      |
| @sophiedlk        | 10             | 16    | Strategy Pattern  |
| @Mariahdlk1989    | 9              | 15    | State Pattern     |
| @xanahid          | 10             | 17    | Circuit Breaker   |

---

_Document maintained collaboratively by all team members_  
